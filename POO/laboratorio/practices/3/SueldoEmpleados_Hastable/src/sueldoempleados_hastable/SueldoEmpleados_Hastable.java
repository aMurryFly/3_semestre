...
package sueldoempleados_hastable;

import java.util.*;

public class SueldoEmpleados_Hastable {

    public static void main(String[] args) {
        
        //Objetos
        Scanner sc = new Scanner(System.in);
        Hashtable <Double, String> empleadosTable = new Hashtable <Double, String>();
        ...
        for (int i = 0; i < empleados.length; i++){
            ...
            empleadosTable.put(sueldos[i],empleados[i]);
        ...
        System.out.println("\nLos datos guardados en el hastable son: \n");
        System.out.println(empleadosTable);
